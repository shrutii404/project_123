    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          “us” and “our” refer to Hurla Paints & Plywood. Hurla Paints & Plywood offers this
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          transferred unencrypted and involve transmissions over various networks and changes to
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          exchange only according to our Refund Policy: [LINK TO REFUND POLICY]
        </Text>
        <Text style={styles.paragraph}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          You agree to indemnify, defend and hold harmless Hurla Paints & Plywood and our parent,
          subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors,
          service providers, sub-contractors, suppliers, interns, and employees from any claim or
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          time without notice and you will remain responsible for all amounts due up to and
