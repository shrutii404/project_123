...
const ManageProfileScreen = () => {
  ...
  // Fix: revert tab type to number, but cast to number in all comparisons
    ...
    <View className="flex-1 bg-white p-2">
      <View className="w-full items-center">
        <View className=" flex-row  h-10 rounded-lg bg-neutral-100 p-1 text-neutral-500 flex items-center justify-center  w-[95%]">
          <Pressable
            className={`flex-1 items-center justify-center h-8   px-1 ${
              Number(tab) === 1 ? 'bg-white z-10 rounded-lg' : ''
            }`}
            onPress={() => handleChangeTab(1)}
          >
            <Text
              className={`${
                Number(tab) === 1 ? 'text-neutral-950' : 'text-neutral-500'
              } font-semibold`}
            >
              Personal Details
            </Text>
          ...
          <Pressable
            className={`flex-1 items-center justify-center h-8  ml-2  px-1 ${
              Number(tab) === 2 ? 'bg-white z-10 rounded-lg' : ''
            }`}
            onPress={() => handleChangeTab(2)}
          >
            <Text
              className={`${
                Number(tab) === 2 ? 'text-neutral-950' : 'text-neutral-500'
              } font-semibold`}
            >
              Shipping Details
            </Text>
          ...
          <Pressable
            className={`flex-1 items-center justify-center h-8 ml-2  px-1 ${
              Number(tab) === 3 ? 'bg-white z-10 rounded-lg' : ''
            }`}
            onPress={() => handleChangeTab(3)}
          >
            <Text
              className={`${
                Number(tab) === 3 ? 'text-neutral-950' : 'text-neutral-500'
              } font-semibold`}
            >
              My Orders
            </Text>
        ...
        <View className="mt-10 w-[95%] border-b border-gray-200 pb-6">
          <Text className="text-black font-bold text-3xl text-left">Profile Details</Text>
        </View>
        {loading && <ShimmerEffect rows={false} />}
        {!loading && (
          <View className="w-[95%]">
