...
const RefundPolicy = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        To start a return, you can contact us at info@hurlahardware.com. Please note that returns will need to be sent to the following address: 
      ...
      <Text style={styles.paragraph}>
        If more than 15 business days have passed since we've approved your return, please contact us at hurlahardware@gmail.com.
      </Text>
    </ScrollView>
  );
};
