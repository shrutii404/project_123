          ...
          <View className="px-4 ">
            ...
            <View className="mt-7">
              <View className="flex-row items-center">
                ...
                <Text className="text-black ml-2 text-sm">
                  (Inc. all taxes)
                </Text>
              </View>
                  ...
                  <View className="border-b border-gray-300 pb-10">
                    <View className="flex-row items-start">
                      ...
                      <Text className="text-gray-400 font-medium ml-2 ">
                        ...
                        :We accept both COD and UPI payment options. In case of
                        COD, 25% of the amount has to be paid in advance via UPI
                        or Bank Transfers. The remaining 75% could be paid on
                        delivery. We also provide a 2% discount to customers who
                    ...
                    <View className="flex-row items-start">
                      ...
                      <Text className="text-gray-400 font-medium ml-2 ">
                        ...
                        :Please note that the amount mentioned is inclusive of
                        all taxes. Delivery charges will be applicable on
                        certain items.
                      </Text>
                    </View>
                    <View className="flex-row items-start">
                      ...
                      <Text className="text-gray-400 font-medium ml-2 ">
                        ...
                        :We’d ask you to send a screenshot of the UPI payment
                        via WhatsApp to confirm your payment.
                      </Text>
                    </View>
                    <View className="flex-row items-start">
                      <View className="bg-gray-400 w-1 h-1 rounded-full mt-2"></View>
                      ...
                      <Text className="text-gray-400 font-medium ml-2 ">
                        <Text className="text-black font-semibold">
                          Your payment information is secure with us. We use
                          industry standard encryption and comply with all
                          related regulations.Payment Methods
                        </Text>
                      </Text>
                    </View>
                    <View className="flex-row items-start">
                      ...
                      <Text className="text-gray-400 font-medium ml-2 ">
                        ...
                        :Cancellation of your order on grounds of damaged
                        products/less quantity received is accepted. We do not
                        accept order cancellation in case of quality issues, as
              ...
              <View className="w-full items-center">
                <View className="flex-row justify-between w-[90%] mb-5">
                  <Text className="text-black font-[500] text-base">
                    Similar Plywood Products
                  </Text>
